...
def get_daily_data(st_code, start_date='20100101', end_date='', ma_type=[20]):
    ...
    try:
        ...
        # pro = ts.pro_api()
        df01 = pro_bar(ts_code=st_code, start_date=start_date, end_date=end_date, asset='E', adj=None, freq='D',ma=ma_type)
        if not df01.empty:
            print(df01)
